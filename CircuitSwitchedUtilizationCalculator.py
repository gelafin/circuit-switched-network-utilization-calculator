...
if __name__ == '__main__':
    # test
    total_user_count = 8  # this should match the total per-user user_counts
    utilization_per_user = [
        {'user_count': 4, 'utilization_percent_per_user': 65},
        {'user_count': 3, 'utilization_percent_per_user': 52},
        {'user_count': 1, 'utilization_percent_per_user': 15}
    ]
